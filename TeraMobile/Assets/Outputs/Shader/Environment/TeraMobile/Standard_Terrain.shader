...
// SH/ambient and vertex lights
			...
			fixed4 frag(v2f_terrain i) : SV_Target
			{
				...
				fixed splatcorrection = (1-(splat_control.r + splat_control.g + splat_control.b + splat_control.a));
				fixed4 diffuse = (splat_control.r+splatcorrection) * tex2D(_Splat0, i.pack0.xy);
				...
				half3 normal;
				half4 nrm = 0.0f;
				nrm += (splat_control.r+splatcorrection) * tex2D(_Normal0, i.pack0.xy);
