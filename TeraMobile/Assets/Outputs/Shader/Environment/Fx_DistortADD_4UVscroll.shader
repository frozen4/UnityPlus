...
Shader "Environment/Fx_distortadd_4UVScroll" {
Properties {
...
v2f vert (appdata_t v)
{
	...
	o.tc0.zw = transform_tex_uv(node_5558, _Mask_UVc_Layer2);
	o.tc1.xy = transform_tex_uv(node_8129, _Mask_UVc_Layer3);
	o.tc1.zw = transform_tex_uv(node_6908, _Mask_UVc_Layer4);
