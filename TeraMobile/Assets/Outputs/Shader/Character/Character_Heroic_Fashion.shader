Shader "Character/Character_Heroic_Fashion" {
    Properties {
...
//                       finalColor = trasission;
//                       finalColor = pow(sqrt(Ndotv),2)*_MatMask_var.r*0.5;
//                       finalColor = Ndotv*_MatMask_var.r*0.5;
//                       finalColor = pow((Ndotv+Vdoti)*0.5,2)*_MatMask_var.r*0.25;
