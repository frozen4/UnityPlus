Shader "Hide/Character/CharacterPass"
{
	Properties
	{
	...
	SubShader
	{
        ...
        Pass {
            ...
            float4 frag1(V2f_TeraPBR i) : COLOR {
// GeometryData:
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag2(V2f_TeraDiffuse i) : COLOR {
                i.normalDir = normalize(i.normalDir);
                float3 lightDirection = normalize(_WorldSpaceLightPos0.xyz);
                float3 viewDirection = normalize(_WorldSpaceCameraPos.xyz - i.posWorld.xyz);
...
/// Final Color:
            ...
            float4 frag3(V2f_TeraDiffuse i) : COLOR {
                i.normalDir = normalize(i.normalDir);
                float3 lightDirection = normalize(_WorldSpaceLightPos0.xyz);
                float3 viewDirection = normalize(_WorldSpaceCameraPos.xyz - i.posWorld.xyz);
                float3 attenColor = _LightColor0.xyz;
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag5(V2f_TeraDiffuse i) : COLOR {
                i.normalDir = normalize(i.normalDir);
                float3 viewDirection = normalize(_WorldSpaceCameraPos.xyz - i.posWorld.xyz);
////// Textures:
                float4 _BaseRGBA_var = tex2D(_BaseRGBA,TRANSFORM_TEX(i.uv0, _BaseRGBA));
