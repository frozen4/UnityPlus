...
public class CameraWrap
{
    ...
    static int get_enabled(IntPtr L)
    {
        ...
        LuaScriptMgr.Push(L, cam.enabled);
        return 1;
    }
    ...
    static int set_enabled(IntPtr L)
    {
        ...
        cam.enabled = LuaScriptMgr.GetBoolean(L, 3);
        return 0;
    }
...
// 		}
// 
// 		LuaScriptMgr.Push(L, obj.pixelRect);
// 		return 1;
// 	}
// 
// 	[MonoPInvokeCallback(typeof(LuaCSFunction))]
