...
{
    //改变模型rim 颜色和 power
    public class EliteBornColor : EntityRimEffect
    {
        private bool _HasRimPropertySetted = false;

        public EliteBornColor()
        {
            Type = EffectType.EliteBornColor;
            SubType = RimEffectType.EliteBornColor;
            Priority = RimEffectPriority.EliteBornColor;
        }
