...
public abstract class IGCloudVoice
{
	...
	/// <summary>
	/// event update Callback.(e.g., the audio device connect)
	/// </summary>
  ...
  /// <summary>
  /// check mute switch state callback. android and iOS simulator will return 0
  /// </summary>
  /// <param name="result">mute state flag</param>
  /// <returns></returns>
...
/// <summary>
    ...
    /// @return: if success return GCLOUD_VOICE_SUCC, failed return other errno @see GCloudVoiceErrno
    /// @see :
    /// - event MuteSwitchResultHandler OnMuteSwitchState
    /// </summary>
