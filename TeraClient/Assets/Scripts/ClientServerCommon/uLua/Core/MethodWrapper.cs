namespace LuaInterface
{
     ...
     */
    struct MethodArgs:IEquatable<MethodArgs>
    {
        ...
        public bool Equals(MethodArgs other)
        {
            ...
            if (!(this.index.Equals(other.index)))
                return false;
            if (!(this.extractValue.Equals(other.extractValue)))
                return false;
            if (!(this.isParamsArray.Equals(other.isParamsArray)))
                return false;
            if (!(this.paramsArrayType.Equals(other.paramsArrayType)))
                return false;
            else
                return true;
        }
        public override bool Equals(object obj)
        {
            if (obj == null)
                return false;
            if (!(obj is MethodArgs))
                return false;
            return Equals((MethodArgs)obj);

        }
        public override int GetHashCode()
        {
            return index.GetHashCode() ^ extractValue.GetHashCode() ^ isParamsArray.GetHashCode() ^ paramsArrayType.GetHashCode();
        }
    }
