...
namespace Fabric.Internal.Crashlytics
{
	...
	public class CrashlyticsInit : MonoBehaviour
	{
		...
		public static void RegisterExceptionHandlers ()
		{
			...
			if (IsSDKInitialized ())
            {
                Common.HobaDebuger.LogWarningFormat("[{0}]Registering exception handlers", kitName);
            ...
            {
                Common.HobaDebuger.LogWarningFormat("[{0}]Did not register exception handlers: Crashlytics SDK was not initialized", kitName);
            }
		}
