...
namespace ProtoBuf
{
    ...
    public sealed class ProtoReader : IDisposable
    {
        ...
        {
            return CreateException("Invalid wire-type; this usually means you have over-written a file without truncating or setting the length");
        }
 ...
 float ReadSingle()
        ...
        internal static Exception AddErrorData(Exception exception, ProtoReader source)
        {
            ...
            {
                exception.Data.Add("protoSource", HobaText.Format("tag={0}; wire-type={1}; offset={2}; depth={3}",
