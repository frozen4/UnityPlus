...
namespace SeasideResearch.LibCurlNet
{
	...
	{        
        ...
        private static Share _CurrentShare = null;           //设置当前使用的easy，因为GCHandle在Mono下不可用
        public static void SetCurrentShare(Share current)
        {
            _CurrentShare = current;
        }
