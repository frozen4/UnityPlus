...
namespace DG.DOTweenEditor
{
    ...
    public class DOTweenAnimationInspector : ABSAnimationInspector
    {
        ...
        static readonly Dictionary<DOTweenAnimationType_My, Type[]> _AnimationTypeToComponent = new Dictionary<DOTweenAnimationType_My, Type[]>() {
            { DOTweenAnimationType_My.Move, new[] { typeof(Rigidbody), typeof(Rigidbody2D), typeof(RectTransform), typeof(Transform) } },
            { DOTweenAnimationType_My.LocalMove, new[] { typeof(Transform) } },
            { DOTweenAnimationType_My.Rotate, new[] { typeof(Rigidbody), typeof(Rigidbody2D), typeof(Transform) } },
            { DOTweenAnimationType_My.LocalRotate, new[] { typeof(Transform) } },
            { DOTweenAnimationType_My.Scale, new[] { typeof(Transform) } },
            { DOTweenAnimationType_My.Color, new[] { typeof(SpriteRenderer), typeof(Renderer), typeof(Image), typeof(Text), typeof(Light) } },
            { DOTweenAnimationType_My.Fade, new[] { typeof(SpriteRenderer), typeof(Renderer), typeof(Image), typeof(Text), typeof(CanvasGroup), typeof(Light) } },
            { DOTweenAnimationType_My.Text, new[] { typeof(Text) } },
            { DOTweenAnimationType_My.PunchPosition, new[] { typeof(RectTransform), typeof(Transform) } },
            { DOTweenAnimationType_My.PunchRotation, new[] { typeof(Transform) } },
            { DOTweenAnimationType_My.PunchScale, new[] { typeof(Transform) } },
            { DOTweenAnimationType_My.ShakePosition, new[] { typeof(RectTransform), typeof(Transform) } },
            { DOTweenAnimationType_My.ShakeRotation, new[] { typeof(Transform) } },
            { DOTweenAnimationType_My.ShakeScale, new[] { typeof(Transform) } },
            { DOTweenAnimationType_My.CameraAspect, new[] { typeof(Camera) } },
            { DOTweenAnimationType_My.CameraBackgroundColor, new[] { typeof(Camera) } },
            { DOTweenAnimationType_My.CameraFieldOfView, new[] { typeof(Camera) } },
            { DOTweenAnimationType_My.CameraOrthoSize, new[] { typeof(Camera) } },
            { DOTweenAnimationType_My.CameraPixelRect, new[] { typeof(Camera) } },
            { DOTweenAnimationType_My.CameraRect, new[] { typeof(Camera) } },
            { DOTweenAnimationType_My.UIWidthHeight, new[] { typeof(RectTransform) } },

            { DOTweenAnimationType_My.Fill, new[] { typeof(Image) } },
        };

#if DOTWEEN_TK2D
        static readonly Dictionary<DOTweenAnimationType_My, Type[]> _Tk2dAnimationTypeToComponent = new Dictionary<DOTweenAnimationType_My, Type[]>() {
            { DOTweenAnimationType_My.Scale, new[] { typeof(tk2dBaseSprite), typeof(tk2dTextMesh) } },
            { DOTweenAnimationType_My.Color, new[] { typeof(tk2dBaseSprite), typeof(tk2dTextMesh) } },
            { DOTweenAnimationType_My.Fade, new[] { typeof(tk2dBaseSprite), typeof(tk2dTextMesh) } },
            { DOTweenAnimationType_My.Text, new[] { typeof(tk2dTextMesh) } }
        };
#endif
#if DOTWEEN_TMP
        static readonly Dictionary<DOTweenAnimationType_My, Type[]> _TMPAnimationTypeToComponent = new Dictionary<DOTweenAnimationType_My, Type[]>() {
            { DOTweenAnimationType_My.Color, new[] { typeof(TextMeshPro), typeof(TextMeshProUGUI) } },
            { DOTweenAnimationType_My.Fade, new[] { typeof(TextMeshPro), typeof(TextMeshProUGUI) } },
            { DOTweenAnimationType_My.Text, new[] { typeof(TextMeshPro), typeof(TextMeshProUGUI) } }
        };
#endif
        ...
        override public void OnInspectorGUI()
        {
            ...
            switch (_src.animationType)
            {
                ...
                case DOTweenAnimationType_My.PunchScale:
                    ...
                    if (_src.animationType == DOTweenAnimationType_My.PunchPosition) _src.optionalBool0 = EditorGUILayout.Toggle("    Snapping", _src.optionalBool0);
                    break;
                case DOTweenAnimationType_My.ShakePosition:
                case DOTweenAnimationType_My.ShakeRotation:
                case DOTweenAnimationType_My.ShakeScale:
                    ...
                    if (_src.animationType == DOTweenAnimationType_My.ShakePosition) _src.optionalBool0 = EditorGUILayout.Toggle("    Snapping", _src.optionalBool0);
                    break;
                case DOTweenAnimationType_My.CameraAspect:
                case DOTweenAnimationType_My.CameraFieldOfView:
                case DOTweenAnimationType_My.CameraOrthoSize:
        ...
        bool Validate()
        {
            if (_src.animationType == DOTweenAnimationType_My.None) return false;
        ...
        DOTweenAnimationType_My AnimationToDOTweenAnimationType_My(string animation)
        {
            if (_datString == null) _datString = Enum.GetNames(typeof(DOTweenAnimationType_My));
            animation = animation.Replace("/", "");
            return (DOTweenAnimationType_My)(Array.IndexOf(_datString, animation));
        }
