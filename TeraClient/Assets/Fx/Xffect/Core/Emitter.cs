...
namespace Xft
{
    ...
    public class Emitter
    {
        ...
        protected int EmitByDistance()
        {
            ...
            Vector3 pos = Layer.ClientTransform.position;
            Vector3 diff = pos - LastClientPos;
            if (diff.sqrMagnitude < EmitDist * EmitDist)
                return 0;
        ...
        public void SetEmitPosition(EffectNode node)
        {
            ...
            else if (Layer.EmitType == (int)EMITTYPE.LINE)  //Line direction is based on client transform's rotation.
            {
