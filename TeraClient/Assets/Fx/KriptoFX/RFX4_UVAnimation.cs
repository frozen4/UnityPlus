...
public class RFX4_UVAnimation : ReusableFx
{
    public int TilesX = 4;
    public int TilesY = 4;
    public int FPS = 30;
    ...
    private void SetSpriteAnimationIterpolated()
    {
        ...
        if (instanceMaterial != null)
        {
            instanceMaterial.SetVector(ShaderIDs.RFXTexNextFrame, new Vector4(size.x, size.y, offset.x, offset.y));
            instanceMaterial.SetFloat(ShaderIDs.RFXInterpolationValue, Mathf.Clamp01(currentInterpolatedTime * FPS));
        }
    }
