...
DEFAULT_INPUT_FILENAME = '../Android/google-services.json'
# Output filename if it isn't set.
DEFAULT_OUTPUT_FILENAME = '../../Kakaogame/AndroidPlugins/KakaoGameSDK.plugin/res/values/google-services.xml'
